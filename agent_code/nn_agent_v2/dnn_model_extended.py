...
class DoubleNNModel_Extended(nn.Module):
    ...
    def __init__(self):
        ...
        if configs.LOAD:
            ...
            self.policy_net = MLP(input_size=117, output_size=6, hidden_size=128)
            self.target_net = MLP(input_size=117, output_size=6, hidden_size=128)
...
class MLP(nn.Module):
    ...
    """
    def __init__(self, input_size=117, output_size=6, hidden_size=128):
