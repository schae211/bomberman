...
configs = edict({
    ...
    "LOAD_PATH": os.path.expanduser("~/bomberman_stats/pretrain_models/26-03-2022-19-01_MLPPlus_1.0_0.9999_0.001_0.99_1_12000_256_deterministic_standard_extended_huber_0.00025_True_10_model.pt"),
